<template>
  <div class="modal-card">
    ...
    <section class="modal-card-body" v-if="sendPlan">
      <b-field grouped>
        <b-field label="Producto">
          <b-select placeholder="Producto" icon="user" v-model="plan.productoId">
            <option v-for="producto in productos" :value="producto.id" disabled>{{ producto.nombre }}</option>
          </b-select>
        </b-field>
        <b-field label="Plan">
          <b-input type="text" v-model="plan.nombre" placeholder="Plan"/>
        </b-field>
      </b-field>
      <div class="columns">
    ...
    <section class="modal-card-body" v-else="sendPlan">
      <b-field grouped>
        ...
        <b-field label="Plan">
          <b-input type="text" v-model="plan.nombre" placeholder="Plan" required expanded />
        </b-field>
      </b-field>
      <div class="columns">
        <div class="column is-4">
